...
export default function Discover() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="font-display text-3xl font-bold tracking-tight">Discover Merchants</h1>
        <p className="mt-1 text-muted-foreground">
          Enter a PIN code to find PAYTM merchants pending KYC in that area.
        </p>
      </div>
          ...
          <form onSubmit={handleSearch} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="flex-1 accent-[hsl(193,100%,47%)]"
              />
            </div>
          </form>
        </CardContent>
          ...
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div>
              <p className="text-sm font-medium">
                {results.count > 0
                  ? `Found ${results.count} merchants pending KYC`
                  : 'No new merchants found in this area'}
              </p>
              <p className="text-xs text-muted-foreground mt-0.5">
                {results.count > 0
                  ? 'Merchants added to your pipeline. Go to Outreach to start their KYC.'
